...
accidents.drop(['Location_Easting_OSGR', 'Location_Northing_OSGR', 'LSOA_of_Accident_Location',
                 '2nd_Road_Class', 'Local_Authority_(District)', 'Local_Authority_(Highway)', 'Junction_Detail', 'Special_Conditions_at_Site',
...
accidents = accidents[accidents.Junction_Control != -1]

accidents.to_csv("/home/shubham/VIT/EDA/J_Component/UK_Accident/Preprocessesed_data/pre_processed_accidents_junction_control.csv")